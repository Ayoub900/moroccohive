...
export default function EditCircuitPage() {
    ...
    const fetchCircuit = async () => {
        try {
            const response = await fetch(`/api/admin/circuits/${params.id}`, {
                credentials: "include"
            })
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-semibold text-foreground">Edit Circuit</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* ... (Kept as is, ensuring context matches for diff) ... */}
